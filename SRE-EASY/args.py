...
parser.add_argument("--log-path", type=str, default="", help="save model to file")
...
args.device = "cuda:" + str(get_least_used_gpu_memory())

if not args.log_path == '':
    if not os.path.exists(args.log_path):
        os.makedirs(args.log_path)
        print(f"file '{args.log_path}' created.")
    else:
        print(f"file '{args.log_path}' already exists.")

    args.save_model = os.path.join(args.log_path, 'model.pt')
    args.save_features = os.path.join(args.log_path, 'features.pt')
